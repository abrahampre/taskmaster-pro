...
$(".list-group").on("blur", "textarea", function(){
  //get theh textarea current value/text
  var text = $(this)
  .val()
  .trim();
...
/////convert em back when the user clicks outside (when elements blur event occurs)
...
$(".list-group").on("blur", "input[type='text']",function(){
  ...
  //replace imput with span element
